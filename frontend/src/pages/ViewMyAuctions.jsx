...
const ViewMyAuctions = () => {
  ...
  return (
    <>
      <div className="w-full ml-0 m-0 h-fit px-5 pt-20 flex flex-col">
        <h1
          className={`text-[#b7791f] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}
        >
          My Auctions
        </h1>
        {loading ? (
