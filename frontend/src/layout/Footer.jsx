...
export const Footer = () => (
  <footer className="mt-12 border-t border-emerald-800 bg-primary text-emerald-100">
    <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr]">
      ...
      <div><h2 className="text-sm font-semibold text-white">Explore</h2><ul className="mt-3 space-y-2 text-sm text-emerald-100/80"><li><Link to="/auctions" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">Auctions</Link></li><li><Link to="/leaderboard" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">Leaderboard</Link></li><li><Link to="/how-it-works-info" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">How It Works</Link></li></ul></div>
      <div><h2 className="text-sm font-semibold text-white">Support</h2><ul className="mt-3 space-y-2 text-sm text-emerald-100/80"><li><Link to="/about" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">About</Link></li><li><Link to="/contact" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">Contact</Link></li><li><Link to="/login" className="transition-colors hover:text-amber-200 focus-visible:text-amber-200">Log In</Link></li></ul></div>
    </div>
